...
@section("content")
    <div class="flex justify-center">
        <div class="w-4/12 bg-white p-6 rounded-lg">
            <h1 class="text-xl font-bold justify-center flex w-full mb-3 text-blue-700">Registration Form</h1>
            <form action="{{ route('register') }}" method="post">
                ...
                <div class="mb-4">
                    ...
                    placeholder="Repeat password"   class="bg-gray-100 border-2 w-full p-2 rounded-lg 
